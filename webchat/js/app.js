window.app = {
	 ...
	 * netty服务后端发布的url地址
	 */
	nettyServerUrl: 'ws://192.168.137.1:8888/ws',
	
	/**
	 * 后端服务发布的url地址
	 */
	serverUrl: "http://192.168.137.1:8080/im_sys/",
	
	/**
	 * 图片服务器的url地址
	 */
	imgServerUrl: 'http://192.168.137.1/lhq/',
	 ...
	 */
	saveUserChatHistory:function(myId,friendId,msg,flag){0
		var me = this;
